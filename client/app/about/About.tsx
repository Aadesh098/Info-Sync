  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">InfoSync?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than InfoSync, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of InfoSync, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created InfoSync &ndash; to provide new programmers
          ...
          <br />
          <br />
          At InfoSync, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But InfoSync is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With InfoSync by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the InfoSync family today and let&apos;s
